...
export type SRC721ContractAbiConfigurables = {
  MAX_SUPPLY: BigNumberish;
};

interface SRC721ContractAbiInterface extends Interface {
  functions: {
...
export class SRC721ContractAbi extends Contract {
  interface: SRC721ContractAbiInterface;
  functions: {
